...
<div class="form-container">
    ...
    <form action="<?= base_url('projects/update/' . $project['id']) ?>" method="post" enctype="multipart/form-data">
        ...
        <input type="text" name="nbrperson" value="<?= esc($project['nbrperson']) ?>">
        ...
        <label>Remark</label>
        <textarea id="remark" name="remark" rows="4" value="<?= esc($project['remark']) ?>"></textarea>
